...
public class InvenUIUP {
	...
	public InvenUIUP() {
		...
		u1 = new JLabel("소보로");
		u1.setFont(new Font("한컴 고딕", Font.PLAIN, 12));
		u1.setBounds(70, 50, 100, 50);
		u2 = new JLabel("크림");
		u2.setFont(new Font("한컴 고딕", Font.PLAIN, 12));
		u2.setBounds(70, 100, 100, 50);
		u3 = new JLabel("케이크");
		u3.setFont(new Font("한컴 고딕", Font.PLAIN, 12));
		u3.setBounds(70, 150, 100, 50);
		u4 = new JLabel("앙버터");
		u4.setFont(new Font("한컴 고딕", Font.PLAIN, 12));
		u4.setBounds(70, 200, 100, 50);
		u5 = new JLabel("소금빵");
		u5.setFont(new Font("한컴 고딕", Font.PLAIN, 12));
		u5.setBounds(70, 250, 100, 50);
		u6 = new JLabel("식빵");
		u6.setFont(new Font("한컴 고딕", Font.PLAIN, 12));
		u6.setBounds(70, 300, 100, 50);
		u7 = new JLabel("크로와상");
		u7.setFont(new Font("한컴 고딕", Font.PLAIN, 12));
		u7.setBounds(70, 350, 100, 50);
		u8 = new JLabel("에그타르트");
		u8.setFont(new Font("한컴 고딕", Font.PLAIN, 12));
		u8.setBounds(70, 400, 100, 50);
		u9 = new JLabel("소시지빵");
		u9.setFont(new Font("한컴 고딕", Font.PLAIN, 12));
		...
		l1 = new JLabel("소보로");
		l1.setFont(new Font("한컴 고딕", Font.PLAIN, 12));
		l1.setBounds(450, 0, 80, 50);
		l2 = new JLabel("크림");
		l2.setFont(new Font("한컴 고딕", Font.PLAIN, 12));
		l2.setBounds(450, 50, 80, 50);
		l3 = new JLabel("케이크");
		l3.setFont(new Font("한컴 고딕", Font.PLAIN, 12));
		l3.setBounds(450, 100, 80, 50);
		l4 = new JLabel("앙버터");
		l4.setFont(new Font("한컴 고딕", Font.PLAIN, 12));
		l4.setBounds(450, 150, 80, 50);
		l5 = new JLabel("소금빵");
		l5.setFont(new Font("한컴 고딕", Font.PLAIN, 12));
		l5.setBounds(450, 200, 80, 50);
		l6 = new JLabel("식빵");
		l6.setFont(new Font("한컴 고딕", Font.PLAIN, 12));
		l6.setBounds(450, 250, 80, 50);
		l7 = new JLabel("크로와상");
		l7.setFont(new Font("한컴 고딕", Font.PLAIN, 12));
		l7.setBounds(450, 300, 80, 50);
		l8 = new JLabel("에그타르트");
		l8.setFont(new Font("한컴 고딕", Font.PLAIN, 12));
		l8.setBounds(450, 350, 80, 50);
		l9 = new JLabel("소시지빵");
		l9.setFont(new Font("한컴 고딕", Font.PLAIN, 12));
		...
		b19 = new JButton("재고 추가");
		b19.setFont(new Font("한컴 고딕", Font.PLAIN, 12));
		...
		b19.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (num1 == 0 && num2 == 0 && num3 == 0 && num4 == 0 && num5 == 0 && num6 == 0 && num7 == 0 && num8 == 0
						&& num9 == 0) {
					JOptionPane.showMessageDialog(f, "수량을 추가하세요", "확인", JOptionPane.CLOSED_OPTION);
				} else {
					c.setB1(cnt1);
					c.setB2(cnt2);
					c.setB3(cnt3);
					...
					JOptionPane.showMessageDialog(f, "추가되었습니다", "확인", JOptionPane.CLOSED_OPTION);
					f.dispose();
					new InvenUIUP();
				}
		...
		c1.setFont(new Font("한컴 고딕", Font.PLAIN, 12));
